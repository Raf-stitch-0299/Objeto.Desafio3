...
public class Carro  {
    ...
    public void exibirInformacao(){
        ...
        System.out.println("Menor preço: " + calculoDoMenorPreco() );
        System.out.println("Maior preço: " + calculoDoMaiorPreco());
    }

    private double calculoDoMenorPreco(){
        double menorPreco = precoAno1;

        if (precoAno2 < precoAno1) {
            menorPreco = precoAno2;
        }
        if (precoAno3 < precoAno3){
            menorPreco = precoAno3;
        }
        return menorPreco;
    }

    private double calculoDoMaiorPreco(){
